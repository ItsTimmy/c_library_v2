...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_REQUEST_SERVICE_VERSION=533, /* Request the version of a specific microservice, or of all microservices. |ID of the microservice to request, or 0 to stream all microservices.| Minimum version of the microservice supported by the system sending this command.| Maximum version of the microservice supported by the system sending this command.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
